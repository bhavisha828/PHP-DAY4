	...
	<div id="page">
		...
		<div id="content">
			<div class="post">
				...
				<div class="entry">
					<p>We provide cake for all types celebrations. You just have to order us a cake and details of cake (which kind of cake, which kind of decorations, what name you want to on cake). </p>
				</div>
			</div>
